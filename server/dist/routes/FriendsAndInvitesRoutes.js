...
const FriendsAndInvitesRoutes = (io) => {
    ...
    router.get("/:user_id", FriendsAndInvitesController_1.getFriendsAndInvites);
    router.get("/getAllFriendsInSession/:user_id", FriendsAndInvitesController_1.getAllFriendsInSession);
    router.delete("/removeFriend/:user_id/:friend_id", FriendsAndInvitesController_1.removeFriend);
    return router;
};
