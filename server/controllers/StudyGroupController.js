...
const getStudyGroupsByUser = async (req, res) => {
    try {
        ...
        if(studyGroups.rows.length > 0){
            const studyGroupsById = studyGroups.rows.reduce((acc, group) => {
...
const inviteToStudyGroup = async (req,res) => {
    try {
...
const respondToStudyGroupInvite = async (req,res) => {
    try {
...
module.exports = { createStudyGroup, joinStudyGroup, getStudyGroupsByUser, inviteToStudyGroup, respondToStudyGroupInvite };
